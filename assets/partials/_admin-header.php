...
<!-- <header>
    ...
    <main id="container">
        <div id="sidebar">
            ...
            <ul id="options">
                ...
                <li class="option <?php if($page=='route'){ echo 'active';}?>">
                    <a href="./route.php">
                    <i class="fas fa-road"></i> Tuyến đường    
                    </a>
                </li>
                ...
                <li class="option <?php if($page=='booking'){ echo 'active';}?>">
                    <a href="./booking.php">
                    <i class="fas fa-ticket-alt"></i> Đặt chỗ
                    </a>
                </li>
                <li class="option <?php if($page=='seat'){ echo 'active';}?>">
                    <a href="./seat.php">
                    <i class="fas fa-th"></i> Chỗ ngồi
                    </a>
                </li>
                <li class="option <?php if($page=='signup'){ echo 'active';}?>">
                    <a href="./signup.php">
                    <i class="fas fa-user-lock"></i> Thêm Admin      
                    </a>
                </li>
            </ul>
        </div>
        <div id="main-content">
            <section id="welcome">
                <ul>
                    <li class="welcome-item">Chào mừng, 
                        <span id="USER">
                            <?php 
                                echo $user_fullname;
                            ?>
                    ...
                    <li class="welcome-item">
                        <button id="logout" class="btn-sm">
                            <a href="../assets/partials/_logout.php">Đăng xuất</a>
                        </button>
                    </li>
                </ul>
            </section>