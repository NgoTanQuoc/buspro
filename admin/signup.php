                ...
                <div>
                    <div id="signupForm">
                        ...
                        <form action="../assets/partials/_handleSignup.php" method="POST">
                            ...
                            <div>
                                <input id="confPassword" type="password" name="confPassword" placeholder="Xác nhận mật khẩu*" required>
                                <span id="confPassErr" class="error"></span>
                            </div>
                            <button id="signup-btn" onlick="done()" type="submit" name="signup">Tiếp tục</button>
                        </form>
                    </div>
                </div>
                <div>
