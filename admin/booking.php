    ...
    <?php
            ...
            */
            if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
            {
                if(isset($_POST["submit"]))
                {
                    ...
                    if($booking_added)
                    {
                        ...
                        <strong>Lỗi!</strong> Đặt chỗ đã tồn tại
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>';
                    }
                }
                if(isset($_POST["edit"]))
                {
                    ...
                    if(!$id_if_customer_exists || $customer_id == $id_if_customer_exists)
                    {
                        ...
                        elseif($updateResult)
                        {
                            ...
                            $messageInfo = "Thông tin khách hàng Đã chỉnh sửa";
                        }
                        else{
                            // Show error alert
            ...
            <?php
                ...
                if(!mysqli_num_rows($resultSqlResult)){ ?>
                    ...
                    <div class="container mt-4">
                        <div id="noCustomers" class="alert alert-dark " role="alert">
                            <h1 class="alert-heading">Không tìm thấy lượt đặt chỗ nào!!</h1>
                            <p class="fw-light">Hãy là người đầu tiên đătj chỗ!</p>
                            <hr>
                            <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                    Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Thêm <i class="fas fa-plus"></i></button> Đã thêm đặt chỗ!
                            </div>
                        </div>
                    </div>
                <?php }
                ...
                <section id="booking">
                    <div id="head">
                        <h4>Tình trạng đặt chỗ</h4>
                    </div>
                    <div id="booking-results">
                        <div>
                            <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Thêm đặt chỗ<i class="fas fa-plus"></i></button>
                        </div>
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        echo number_format($booked_amount) . ' VND';
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                ...
                                <button class="button btn-sm edit-button" data-link="<?php echo $_SERVER['REQUEST_URI']; ?>" data-customerid="<?php 
                                                    ...
                                                    echo $customer_phone;?>" >Sửa</button>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        ...
                        <div class="modal-body">
                            <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="cid" class="form-label">ID khách hàng</label>
                                ...
                                <div class="mb-3">
                                    <label for="cname" class="form-label">Tên khách hàng</label>
                                    <input type="text" class="form-control" id="cname" name="cname" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="cphone" class="form-label">Số điện thoại</label>
                                    <input type="tel" class="form-control" id="cphone" name="cphone" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="routeSearch" class="form-label">Tuyến đường</label>
                                    <!-- Search Functionality -->
                                    <div class="searchQuery">
                                ...
                                <div class="mb-3">
                                    <label for="sourceSearch" class="form-label">Nguồn</label>
                                    <!-- Search Functionality -->
                                    <div class="searchQuery">
                                ...
                                <div class="mb-3">
                                    <label for="destinationSearch" class="form-label">Điểm đến</label>
                                    <!-- Search Functionality -->
                                    <div class="searchQuery">
                                ...
                                <div class="row g-3 align-items-center mb-3">
                                    <div class="col-auto">
                                        <label for="seatInput" class="col-form-label">Số ghế</label>
                                    </div>
                                    <div class="col-auto">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        Chọn từ hình trên, Tối đa 1 chỗ ngồi.
                                        </span>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="bookAmount" class="form-label">Tổng cộng</label>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">
                    ...
                    <p>
                    Bạn có thực sự muốn xóa lượt đặt chỗ này không? <strong>Quá trình này không thể được hoàn tác.</strong>
                    </p>
                    <!-- Needed to pass id -->
