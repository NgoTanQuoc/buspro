...
<head>
    ...
    <title>Admin-Trang thống kê </title>
        <!-- google fonts -->
            ...
            <section id="dashboard">
                ...
                <div id="status">
                    <div id="Booking" class="info-box status-item">
                        ...
                        <a href="./booking.php">Xem thêm <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Bus" class="info-box status-item">
                        ...
                        <a href="./bus.php">Xem thêm <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Route" class="info-box status-item">
                        ...
                        <a href="./route.php">Xem thêm <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Seat" class="info-box status-item">
                        ...
                        <a href="./seat.php">Xem thêm <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <!-- <h3>User</h3> -->
                <div id="user">
                    <div id="Customer" class="info-box user-item">
                        ...
                        <a href="./customer.php">Xem thêm <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Admin" class="info-box user-item">
                        ...
                        <a href="#admin">Xem thêm <i class="fas fa-arrow-right"></i></a>
                    </div>
                    ...
                    <div id="Earning" class="info-box user-item">
                        ...
                        <div class="info-content">
                            ...
                            <?php 
                                ...
                                $sum = $row['value_sum'];
                            ?>
                        <p class="num" data-target="<?php echo $sum; ?>">
                ...
                <h4>Quản trị viên khác</h4>
                <div id="admin">
                    <?php 
                        // Lặp qua Dữ liệu quản trị viên và hiển thị quản trị viên trong các hộp không phải là quản trị viên hiện tại là $user_id == $_SESSION["user_id"]
                        ...
                        ?>
                            <div class="info-box admin-item">
                                ...
                                <p class="bio">Quản trị viên khác</p>
                            </div>
                        <?php 
                        }
                    ?>
