    ...
    <?php
        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if($bus_added)
                {
                    ...
                    <strong>Lỗi!</strong> Xe buýt đã tồn tại
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            }
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_bus_exists || $id == $id_if_bus_exists)
                {
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "Chi tiết xe buýt Đã chỉnh sửa";
                    }
                    else{
                        // Show error alert
            ...
            if(isset($_POST["delete"]))
            {
                ...
                {   
                    ...
                    // Show success alert
                    $messageStatus = "success";
                    $messageInfo = "Chi tiết xe buýt đã bị xóa";
                    $messageHeading = "Thành công!";
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Không tìm thấy xe buýt!!</h1>
                        <p class="fw-light">Hãy là người đầu tiên thêm một!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                            Bấm vào <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Thêm <i class="fas fa-plus"></i></button> to add a bus!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="bus">
                <div id="head">
                    <h4>Trạng thái xe buýt</h4>
                </div>
                <div id="bus-results">
                    <div>
                        <button id="add-button" class="button btn-sm" type="button"data-bs-toggle="modal" data-bs-target="#addModal">Thêm xe buýt <i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Thêm xe buýt</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="addBusForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                <label for="busnumber" class="form-label">Số xe buýt</label><br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Bạn có thực sự muốn xóa xe buýt này?
                </p>
                <!-- Needed to pass id -->
