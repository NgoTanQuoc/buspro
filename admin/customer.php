        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
                ...
                */
                ...
                if(!$customer_exists)
                {
                    ...
                    if($autoInc_id)
                    {
                        ...
                        $customer_id = "KH-".$code.$autoInc_id;
            ...
            if(isset($_POST["delete"]))
            {
                ...
                {   
                    ...
                    $messageInfo = "Chi tiết khách hàng đã bị xóa";
                    $messageHeading = "Thành công!";
                }
                else{
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Không tìm thấy khách hàng nào!!</h1>
                        <p class="fw-light">Hãy là người đầu tiên thêm một!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Bấm vào <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Thêm <i class="fas fa-plus"></i></button> Đã thêm một khách hàng!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="customer">
                ...
                <div id="customer-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Thêm chi tiết khách hàng <i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Bạn có thực sự muốn xóa những chi tiết khách hàng này? <strong></strong>
                </p>
                <!-- Needed to pass id -->
